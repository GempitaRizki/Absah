            ...
            <div class="category-heading-2">
                ...
                <div class="category-menu-list">
                    <ul>
                        ...
                        <li>
                            <a href="#"><img alt="" src="{{url('assets/img/icon-img/18.png')}}">TV & Audio </a>
                        </li>
                        <li>
                            <a href="#"><img alt="" src="{{url('assets/img/icon-img/19.png')}}"> Game & Play Station</a>
                        </li>
                        <li>
                            <a href="#"><img alt="" src="{{url('assets/img/icon-img/20.png')}}"> Car Electronics </a>
                        </li>
                        <li>
                            <a href="#"><img alt="" src="{{url('assets/img/icon-img/21.png')}}"> Accessories </a>
                        </li>
                        <li>
                            <a href="#"><img alt="" src="{{url('assets/img/icon-img/22.png')}}"> Gadgets</a>
                        </li>
                        <li>
                            <a href="#"><img alt="" src="{{url('assets/img/icon-img/23.png')}}">Others Equipment</a>
                        </li>
                    </ul>
                </div>
            </div>
