...
<html lang="en" dir="ltr">
  <head>
    ...
    <link href="{{url('admin/assets/plugins/nprogress/nprogress.css')}}" rel="stylesheet" />
  
    <!-- No Extra plugin used -->
    <link href="{{url('admin/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.css')}}" rel="stylesheet">
    ...
    <script src="{{url('admin/assets/plugins/nprogress/nprogress.js')}}"></script>
  </head>
  ...
  <body class="header-fixed sidebar-fixed sidebar-dark header-light" id="body">
    ...
    <script src="{{url('admin/assets/js/vector-map.js')}}"></script>
    ...
    <script src="{{url('admin/assets/js/sleek.js')}}"></script>
  <link href="{{url('admin/assets/options/optionswitch.css')}}" rel="stylesheet">
<script src="{{url('admin/assets/options/optionswitcher.js')}}"></script>
<script>
