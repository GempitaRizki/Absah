                    ...
                    <div class="card-body">
                        ...
                        <div id="accordion-role-permission" class="accordion accordion-bordered ">
                            @forelse ($roles as $role)
                                ...
                                @if($role->name === 'Admin')
                                    @include('admin.roles.permissions', ['title' => $role->name .' Permissions', 'options' => ['disabled'], 'showButton' => true])
                                @else
                                    @include('admin.roles.permissions', ['title' => $role->name .' Permissions', 'model' => $role, 'showButton' => true])
                                @endif
