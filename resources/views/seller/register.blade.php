                            ...
                            <div class="login-form">
                                <form method="POST" action="{{ route('StoreSellerSession') }}">
                                    ...
                                    <div class="form-group row">
                                        <label for="surel" class="col-md-4 col-form-label text-md-end text-start required-label">Surel</label>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control @error('surel') is-invalid @enderror"
                                                id="surel" name="surel" value="{{ Session::get('sellerData.surel') }}"
                                                required>
                                            @if ($errors->has('surel'))
                                    ...
                                    <div class="form-group row">
                                        <label for="password" class="col-md-4 col-form-label text-md-end text-start required-label">Password</label>
                                        <div class="col-md-6">
                                            <input type="password"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text"
                                                ...
                                                value="{{ Session::get('sellerData.store_name') }}" required>
