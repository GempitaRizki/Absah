                    ...
                    {!! Form::open(['url' => route('cart.store', ['product' => $product->id])]) !!}
                        ...
                        <div class="quickview-plus-minus">
                            <div class="cart-plus-minus">
                                {!! Form::number('qty', 1, ['class' => 'cart-plus-minus-box', 'placeholder' => 'qty', 'min' => 1, 'required' => true]) !!}
                            </div>
                            <div class="quickview-btn-cart">
                                <button type="submit" class="submit contact-btn btn-hover">Add to Cart</button>
                            </div>
                            <div class="quickview-btn-wishlist">
                                <a class="btn-hover" href="{{ route('favorites.add', ['product' => $product->id]) }}"><i class="pe-7s-like"></i></a>
                            </div>
                        </div>
                    {!! Form::close() !!}
